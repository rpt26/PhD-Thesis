...
\hline
\ce{Ti2Ni} \rule{0pt}{2.5ex}               & 10.61 & 0.38 & 30 & 0.444 \\ % the strut adds a little space at the top of the table
...
The mixed stoichiometries, \ce{Ti2(Co,Ni)} and \ce{(Hf,Ti)_{2}Ni} fit the trend well and do not exhibit any solution hardening as might be expected. Particularly noteworthy is that \ce{Ti2(Co,Ni)} has an intermediate value of electronegativity difference and falls on the trend between the the extreme cases.
